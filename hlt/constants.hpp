...
namespace hlt {
    ...
    namespace constants {
        ...
        /**
         * 1/EXTRACT_RATIO halite (rounded) is collected from a square per
         * turn.
         */
        ...
        /**
         * An inspired ship that removes Y halite from a cell collects X*Y
         * additional halite.
         */
        ...
        /** Constant for halite worth mining. */
        const int HALITE_WORTH_MINING = 50;
    }
}
